...
$(document).ready(function() {
    ...
    // $('a[data-hover="dropdown"]').hover( function (e) {
    //     $(this).closest('li').children('ul.dropdown-menu').css({display:'inline-block'});
    //     console.log('ss');
    //     console.log(  $(this).closest('li').children('ul.dropdown-menu'));
    // },
    //     function (e) {
    //     $(this).closest('li').children('ul.dropdown-menu').css({display:'none'});
    //     console.log('ss');
    //     console.log(  $(this).closest('li').children('ul.dropdown-menu'));
    // }
    //
